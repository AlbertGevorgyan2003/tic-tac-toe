...
let player = "x";
let counter = 0;//we will check how many times the loop has worked
while (true) {
    counter++;
    ...
    let result; 
    if (counter > 4) {//we are checking if there are already 5 moves and starting to check
